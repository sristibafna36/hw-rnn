...
def posterior_error_rate(model: HiddenMarkovModel, eval_corpus: TaggedCorpus, known_vocab: Optional[Integerizer[Word]] = None, show_cross_entropy = True) -> float:
    if show_cross_entropy:
        model_cross_entropy(model=model, eval_corpus=eval_corpus)
